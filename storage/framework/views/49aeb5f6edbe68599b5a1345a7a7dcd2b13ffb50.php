...
<div class="container">
    <div class="header mt-4 mb-4 pl-4 pt-3 pb-3 bg-light shadow">
        ...
        <div class="text-center">
            <img src="<?php echo e(('img/fotoe.jpg')); ?>" class="p" alt="...">
        </div>
        <br>
        <div class="content">
            <p>Nama saya <b> <?php echo e($nama); ?> </b> umur saya 16 tahun saya lahir
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cobaLaravel\resources\views/profile.blade.php ENDPATH**/ ?>