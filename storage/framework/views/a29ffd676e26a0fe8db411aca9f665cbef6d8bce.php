...
<body class="bg-dark">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow p-3">
        <div class="container">
            <a class="navbar-brand" href="#" style="font-family: 'Bangers'; font-size: 30px;">Daffa Bagus</a>
    ...
    <script src="https://use.fontawesome.com/0cd96d1eb3.js"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\cobaLaravel\resources\views/layout/main.blade.php ENDPATH**/ ?>