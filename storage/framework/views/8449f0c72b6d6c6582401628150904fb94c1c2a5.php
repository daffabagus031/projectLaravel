...
<style>
    .jumbotron {
        background-image: url("<?php echo e(('img/b.jpg')); ?>");
        background-size: 100%;
...
<div class="jumbotron jumbotron-fluid text-white shadow">
    <div class="container">
        <img src="<?php echo e(('img/fotoe.jpg')); ?>" class="rounded-circle float-right border border-dark " alt="...">
        <br>
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cobaLaravel\resources\views/portofolio.blade.php ENDPATH**/ ?>