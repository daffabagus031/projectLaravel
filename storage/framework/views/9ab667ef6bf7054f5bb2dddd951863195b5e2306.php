...
<?php $__env->startSection('title', 'Daffa Bagus'); ?>
<style>
    .w-100 {
        width: 100%;
        height: 65%;
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo e(('img/tl.jpg')); ?>" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
            <img src="<?php echo e(('img/c.jpg')); ?>" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block text-white">
        ...
        <div class="carousel-item">
            <img src="<?php echo e(('img/tw.jpg')); ?>" class="d-block w-100" alt="...">
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cobaLaravel\resources\views/index.blade.php ENDPATH**/ ?>